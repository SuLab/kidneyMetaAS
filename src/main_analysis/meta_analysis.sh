...
head -n1 ${plink_results_dir}/${batch}.assoc.fisher | awk '{$1=$1; print $0}' OFS='\t' > ${plink_results_dir}/plink_ci.header
...
cat ${plink_results_dir}/plink_ci.header ${plink_results_dir}/${batch}.assoc.fisher.logor.body > ${plink_results_dir}/${batch}.assoc.fisher.logor
